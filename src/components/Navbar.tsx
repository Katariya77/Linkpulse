  ...
  const navItems = [
    {
      ...
      subtitle: 'Browse live peers & real-time traffic pool',
      icon: Users,
      badge: undefined,
    },
    {
      ...
      subtitle: hasActiveSession ? 'Synchronized verification room active' : 'Launch 1-on-1 link exchange room',
    ...
    },
    {
      ...
      label: 'Leaderboard',
      subtitle: 'Top nodes, reputation tiers & success metrics',
      icon: Trophy,
      badge: undefined,
    },
    {
      id: 'goals' as const,
      label: 'Daily Quests',
      subtitle: 'Daily verification challenges & XP milestones',
      icon: Target,
      badge: '2/4',
    },
    {
      ...
      subtitle: currentUser.email ? `Connected as ${currentUser.email}` : 'Firebase Google & Email + Password Auth',
      icon: KeyRound,
